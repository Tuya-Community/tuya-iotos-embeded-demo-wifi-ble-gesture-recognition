# Tuya IoTOS Embeded Demo WiFi & BLE gesture recognition
...
This Demo is based on Tuya Smart Cloud Platform, Tuya Smart APP, IoTOS Embeded WiFi &Ble SDK, using Tuya WiFi/WiFi+BLE series modules to quickly set up a gesture recognition demo with detecting and recognizing gesture actions and displaying the detection and recognition results on the mobile app.
## Quick start
...
+ Call the application layer initialization function app_gesture_init()
